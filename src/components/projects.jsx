...
export default function Projects() {
  return (
    <div id="projects" className='flex flex-col glassBorderBottom'>
        ...
        <div className="container my-24 mx-auto md:px-6 text-[#dbd9e8] flex flex-col md:flex-row items-center">
            ...
            <div className='flex flex-col pt-8 md:w-1/2'>
                ...
                <div>
                    ...
                    <div className="flex flex-row px-2 font-sans font-arim pt-2">
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">React</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">MongoDB</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">NodeJS</div>
        ...
        <div className="container my-24 mx-auto md:px-6 text-[#dbd9e8] flex flex-col md:flex-row-reverse items-center">
            <img src={process.env.PUBLIC_URL + '/imgs/magicmatch.PNG'}
                className="mb-3 p-8 rounded-lg max-w-full h-auto md:w-1/2 md:mr-8" alt="image" />
            ...
            <div className='flex flex-col pt-8 md:w-1/2'>
                ...
                <div>
                    ...
                    <div className="flex flex-row px-2 font-sans font-arim pt-2">
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">NextJs</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">Prisma</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">MySQL</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">NodeJS</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">ChartJS</div>
                        <div class="rounded-full bg-zinc-900 text-[#d2ee41] p-2">TailwindCSS</div>
                    </div>
                </div>
                </div>
                ...
                Bankera is my first group project developed as engineer's thesis with full documentation and production version available
                </p>
...
<ol
  class="mt-8 px-8 border-l border-[#d2ee41] dark:border-[#ce2d42] md:flex md:justify-center md:gap-6 md:border-l-0 md:border-t">
